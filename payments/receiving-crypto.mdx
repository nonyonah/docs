...
- **Stacks address** — used for payments on Stacks, the Bitcoin Layer 2.
...
<CardGroup cols={2}>
  ...
  <Card title="Stacks / Bitcoin L2 (STX)" icon="bitcoin-sign">
    Stacks brings smart contract capabilities to Bitcoin. Clients on Stacks pay in STX and their payment is settled to your Stacks address.
  </Card>
</CardGroup>
